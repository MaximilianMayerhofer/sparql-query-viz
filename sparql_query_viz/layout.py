    ...
    dbc.FormText(
        create_row([
            dcc.Dropdown(
                ...
                options=[
                    {'label': 'Count Number of owl-Classes', 'value': 'template_1.sparql'},
                    {'label': 'Count Number of Instances of a Class', 'value': 'template_4.sparql'},
                    {'label': 'Ask for Instance with Property', 'value': 'template_12.sparql'},
                    {'label': 'Describe an Instance', 'value': 'template_13.sparql'},
                    {'label': 'Select Min and Max of Data Property', 'value': 'template_8.sparql'},
                    {'label': 'Select Subclasses of a Class', 'value': 'template_10.sparql'},
                    {'label': 'Select Instances with specific Property', 'value': 'template_2.sparql'},
                    {'label': 'Select Instances and Property Range', 'value': 'template_5.sparql'},
                    {'label': 'Select Instances and specific Property Range', 'value': 'template_6.sparql'},
                    {'label': 'Select Instances with various Properties', 'value': 'template_7.sparql'},
                    {'label': 'Select Instances that unite two Classes', 'value': 'template_11.sparql'},
            ...
            dcc.Dropdown(
                ...
                options=[
                    ...
                    {'label': 'Inconsistency Query Template 4', 'value': 'template_18.sparql'},
                    {'label': 'Inconsistency Query Template 5', 'value': 'template_19.sparql'},
                    {'label': 'Inconsistency Query Template 6', 'value': 'template_20.sparql'},
                ],
